...
/*-----------------------------------------------------*/
	global $wpdb;
    $table_setting=$wpdb->prefix.$id.'_' . "ccf_Fields";
	$table_term = $wpdb->prefix.$id.'_'."terms";
    $table_values=$wpdb->prefix.$id.'_' . "ccf_Value";
	
	
	
	$wpdb->query("CREATE TABLE " . $table_setting . " (	  
     ...
     $wpdb->query("CREATE TABLE " . $table_values . " (
